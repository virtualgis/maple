...
(function(){
    ss.extendObj( ss.SimpleUpload.prototype, {
        ...
        _createInput: function() {
            ...
            this._input.dojoClick = false;
            ss.addEvent( this._input, 'click', function(e){
            	e.stopPropagation();
            });
        ...
        rerouteClicks: function( elem ) {
            ...
            elem.off = (function(){
	            ...
	            ss.addEvent( elem, 'mouseover', mouseOverHandler);
	            ss.addEvent( elem, 'touchstart', touchStartHandler);
            	
            	return function() {
            		ss.removeEvent( elem, 'mouseover', mouseOverHandler );
			        ss.removeEvent( elem, 'touchstart', touchStartHandler );
			    };
            })();
