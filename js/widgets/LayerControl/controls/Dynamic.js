    ...
    var DynamicControl = declare([_WidgetBase, _TemplatedMixin, _Contained, _Control], {
        ...
        _layerTypeInit: function () {
            ...
            if (isLegend && this.controlOptions.sublayers === true) {
                ...
                // Lazy load legend symbols
                var legendLoaded = false;
                this.expandNode.legendErrorCallback = function(){
                    legendLoaded = false;
                };
                on(this.expandClickNode, 'click', lang.hitch(this, function () {
                    if (!legendLoaded){
                        legendLoaded = true; // Assume success, will set to false in case of error
        ...
        _setVisibleLayers: function () {
            ...
            var layer = this.layer,
                setLayers = [];
            array.forEach(query('.' + utils.cssSafe(layer.id) + '-layerControlSublayerCheck'), function (i) {
