define([
    ...
    var _Control = declare([], {
        ...
        _initialize: function () {
            ...
            topic.subscribe("layerControl/setLayerVisibility", lang.hitch(this, function(e){
                if (e.layer.id === layer.id){
                    // _setLayerVisibility is actually a toggle,
                    // so invert the visible attribute to get the desired behavior
                    layer.visible = !e.visible;
                    this._setLayerVisibility(layer, this.checkNode);                    
                }
            }));
            ...
            if (layer.minScale !== 0 || layer.maxScale !== 0) {
                ...
                this._scaleRangeHandler = layer._mapRef.on('zoom-end', lang.hitch(this, '_checkboxScaleRange'));
            }
